...
class BPEGraph : UIViewController, CPTScatterPlotDataSource, CPTAxisDelegate {
    ...
    override func viewDidAppear(_ animated : Bool)
    {
        ...
        plotSpace.yRange = CPTPlotRange(location:1.0, length:200.0)
        plotSpace.xRange = CPTPlotRange(location:1.0, length:100.0)
